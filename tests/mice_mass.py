...
cv.putText(mice, 'Pixels count: ' + str(mass_total), (10,50), cv.FONT_HERSHEY_COMPLEX_SMALL, 0.5, (0, 255, 0))
cv.putText(mice_out, 'Pixels count: ' + str(mass_out), (10,50), cv.FONT_HERSHEY_COMPLEX_SMALL, 0.5, (0, 255, 0))
cv.putText(mice_in, 'Pixels count: ' + str(mass_in), (10,50), cv.FONT_HERSHEY_COMPLEX_SMALL, 0.5, (0, 255, 0))
