    ...
    <div className="space-y-6">
      <div className="bg-white dark:bg-gray-800 rounded-lg p-6 border border-gray-200 dark:border-gray-700">
        ...
        <div className="mb-6">
          ...
          {gpuStatus && (
            <div className="mt-4 bg-gray-50 dark:bg-gray-700/50 rounded-lg p-4 border border-gray-200 dark:border-transparent">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <div className="text-sm text-gray-600 dark:text-gray-400 uppercase">{gpuStatus.device}</div>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div>
          ...
          {yoloTest && (
            <div className="mt-4 bg-gray-50 dark:bg-gray-700/50 rounded-lg p-4 border border-gray-200 dark:border-transparent">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div>
                  <div className="text-gray-600 dark:text-gray-400 mb-1">GPU Inference Time</div>
                ...
                <div>
                  <div className="text-gray-600 dark:text-gray-400 mb-1">CPU Inference Time</div>
                ...
                <div>
                  <div className="text-gray-600 dark:text-gray-400 mb-1">Speedup</div>
              ...
              {yoloTest.gpuTime === 0 && (
                <div className="mt-4 p-3 bg-yellow-50 dark:bg-yellow-900/20 border border-yellow-300 dark:border-yellow-600 rounded-lg text-yellow-700 dark:text-yellow-400 text-sm">
